...
var _inheritsLoose = _interopDefault(
  ...
  _regeneratorRuntime = _interopDefault(require('@babel/runtime/regenerator')),
  ...
  jpegasus = _interopDefault(require('jpegasus')),
  toBufferCb = _interopDefault(require('blob-to-buffer')),
  toArrayBuffer = _interopDefault(require('to-arraybuffer')),
  PNG = _interopDefault(require('@react-pdf/png-js')),
  _wrapPages = _interopDefault(require('page-wrapping'));
...
var __DEV__ = 'production' !== process.env.NODE_ENV,
    ...
    ? function(t, e) {
        ...
        if (!t) {
          for (
            ...
            n[i - 2] = arguments[i];
          printWarning.apply(void 0, [e].concat(n));
        }
      }
    : function() {},
  Root = (function() {
  ...
  isBorderStyle = function(t, e) {
    return t.match(/^border/) && 'string' == typeof e;
  },
  matchBorderShorthand = function(t) {
    return t.match(/(\d+(px|in|mm|cm|pt)?)\s(\S+)\s(\S+)/);
  },
  processBorders = function(t, e) {
    var r = matchBorderShorthand(e);
    if (r) {
  ...
  isBoxModelStyle = function(t, e) {
    return t.match(/^(margin)|(padding)/) && 'string' == typeof e;
  },
  matchBoxModel = function(t) {
    return t.match(/\d+(px|in|mm|cm|pt|%)?/g);
  },
  processBoxModel = function(t, e) {
    var r = matchBoxModel(e);
    if (r) {
  ...
  isFontWeightStyle = function(t) {
    return t.match(/^fontWeight/);
  },
  processFontWeight = function(t) {
    return t
      ? 'number' == typeof t
        ? t
  ...
  isObjectPositionStyle = function(t, e) {
    return t.match(/^objectPosition/) && 'string' == typeof e;
  },
  matchObjectPosition = function(t) {
    return t.match(/\d+(px|in|mm|cm|pt|%)?/g);
  },
  processObjectPosition = function(t, e) {
    var r = matchObjectPosition(e);
    if (r) {
  ...
  isTransformOriginStyle = function(t, e) {
    return t.match(/^transformOrigin/) && 'string' == typeof e;
  },
  matchTransformOrigin = function(t) {
    return t.match(/(-?\d+(px|in|mm|cm|pt|%)?)|top|right|bottom|left|center/g);
  },
  transformOffsetKeywords = function(t) {
    switch (t) {
      case 'top':
      case 'left':
        return '0%';
  ...
  processTransformOrigin = function(t, e) {
    var r = matchTransformOrigin(e);
    if (r) {
      var n;
      if (t.match(/.X/)) n = r[0];
      else {
      ...
      return transformOffsetKeywords(n);
    }
    return e;
  },
    ...
    for (var e = Object.keys(t), r = {}, n = 0; n < e.length; n++) {
      ...
      switch (i) {
        ...
        case 'transformOrigin':
          var a = styleShorthands[i];
          for (var s in a) hasOwnProperty.call(a, s) && (r[s] = o);
          break;
        default:
          r[i] = o;
      }
  ...
  transformStyles = function(t) {
    for (
      var e = expandStyles(t), r = Object.keys(e), n = {}, i = 0;
      i < r.length;
      i++
    ) {
      var o = r[i],
      ...
      (s = isBorderStyle(o, a)
        ...
        : isBoxModelStyle(o, a)
        ? processBoxModel(o, a)
        : isObjectPositionStyle(o, a)
        ? processObjectPosition(o, a)
        : isTransformOriginStyle(o, a)
        ? processTransformOrigin(o, a)
        : isFontWeightStyle(o)
        ? processFontWeight(a)
        : a),
        (n[o] = parseScalar(s));
  ...
  resolveMediaQueries = function(t, e) {
    return Object.keys(t).reduce(function(r, n) {
      var i, o;
      return /@media/.test(n)
        ? _extends({}, r, matchMedia((((o = {})[n] = t[n]), o), e))
        : _extends({}, r, (((i = {})[n] = t[n]), i));
    }, {});
  },
...
function drawBorders() {
  var t = this.root.instance,
    ...
    E = a.borderLeftStyle,
    R = void 0 === E ? 'solid' : E,
    w = a.borderRightColor,
    P = void 0 === w ? 'black' : w,
    x = a.borderRightStyle,
    C = void 0 === x ? 'solid' : x,
    k = a.borderBottomColor,
    S = void 0 === k ? 'black' : k,
    A = a.borderBottomStyle,
    L = {
      borderTopColor: y,
      borderTopWidth: r,
      borderTopStyle: b,
    ...
    I = e.width,
    D = e.height,
    O = Math.min(l, 0.5 * I, 0.5 * D),
    F = Math.min(c, 0.5 * I, 0.5 * D),
    B = Math.min(g, 0.5 * I, 0.5 * D),
    M = Math.min(f, 0.5 * I, 0.5 * D);
  t.save(),
    t.strokeOpacity(s),
    r &&
      (t.save(),
      clipBorderTop(t, e, L, O, F),
      fillBorderTop(t, e, L, O, F),
      t.restore()),
    i &&
      (t.save(),
      clipBorderRight(t, e, L, O, B),
      fillBorderRight(t, e, L, O, B),
      t.restore()),
    o &&
      (t.save(),
      clipBorderBottom(t, e, L, M, B),
      fillBorderBottom(t, e, L, M, B),
      t.restore()),
    n &&
      (t.save(),
      clipBorderLeft(t, e, L, M, F),
      fillBorderLeft(t, e, L, M, F),
      t.restore()),
    t.restore();
}
var clipBorderTop = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.width,
      u = e.height,
      c = r.borderTopWidth,
      h = r.borderRightWidth,
      l = r.borderLeftWidth;
    t.moveTo(a + i, o), t.lineTo(a + s - n, o);
    var d = n * (1 - KAPPA);
    t.bezierCurveTo(a + s - d, o, a + s, o + d, a + s, o + n);
    var f = o + Math.max(c, n);
    t.lineTo(a + s, f), t.lineTo(a + s - h, f);
    var p = Math.max(n - h, 0),
      g = Math.max(n - c, 0),
      m = p * (1 - KAPPA),
      y = g * (1 - KAPPA);
    t.bezierCurveTo(
      ...
      t.lineTo(a + Math.max(i, l), o + c);
    var v = Math.max(i - l, 0),
      b = Math.max(i - c, 0),
      T = v * (1 - KAPPA),
      _ = b * (1 - KAPPA),
      E = o + Math.max(c, i);
    t.bezierCurveTo(a + l + T, o + c, a + l, o + c + _, a + l, E),
      t.lineTo(a, E),
      t.lineTo(a, o + i);
    var R = i * (1 - KAPPA);
    if (
      (t.bezierCurveTo(a, o + R, a + R, o, a + i, o),
      t.closePath(),
      t.clip(),
      h)
    ) {
      var w = -c / h;
      t.moveTo(a + s / 2, w * (-s / 2) + o),
        t.lineTo(a + s, o),
        t.lineTo(a, o),
        t.lineTo(a, o + u),
        t.closePath(),
  ...
  fillBorderTop = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.width,
      u = r.borderTopColor,
  ...
  clipBorderRight = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.width,
      u = e.height,
    ...
    var f = a + s - Math.max(h, i);
    t.lineTo(f, o + u), t.lineTo(f, o + u - l);
    var p = Math.max(i - h, 0),
      g = Math.max(i - l, 0),
      m = p * (1 - KAPPA),
      y = g * (1 - KAPPA);
    t.bezierCurveTo(
      ...
      t.lineTo(a + s - h, o + Math.max(n, c));
    var v = Math.max(n - h, 0),
      b = Math.max(n - c, 0),
      T = v * (1 - KAPPA),
      _ = b * (1 - KAPPA),
      E = a + s - Math.max(n, h);
    t.bezierCurveTo(a + s - h, o + c + _, a + s - h - T, o + c, E, o + c),
      t.lineTo(E, o),
      t.lineTo(a + s - n, o);
    var R = n * (1 - KAPPA);
    if (
      (t.bezierCurveTo(a + s - R, o, a + s, o + R, a + s, o + n),
      t.closePath(),
      t.clip(),
      c)
    ) {
  ...
  fillBorderRight = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.width,
      u = e.height,
      c = r.borderRightColor,
      h = r.borderRightStyle,
      l = r.borderRightWidth,
      d = r.borderTopWidth,
    ...
    t.moveTo(a + s - n, o),
      ...
      'dashed' === h
        ...
        : 'dotted' === h && t.dash(l, { space: 1.2 * l }),
      t.stroke(),
      t.undash();
  },
  clipBorderBottom = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.width,
      u = e.height,
    ...
    t.bezierCurveTo(
      ...
      t.lineTo(a + s - Math.max(i, h), o + u - c);
    var v = Math.max(i - h, 0),
      b = Math.max(i - c, 0),
      T = v * (1 - KAPPA),
      _ = b * (1 - KAPPA),
      E = o + u - Math.max(c, i);
    ...
    var R = i * (1 - KAPPA);
    if (
      (t.bezierCurveTo(a + s, o + u - R, a + s - R, o + u, a + s - i, o + u),
      t.closePath(),
      t.clip(),
      h)
    ) {
      var w = c / h;
      t.moveTo(a + s / 2, w * (-s / 2) + o + u),
        t.lineTo(a + s, o + u),
        t.lineTo(a, o + u),
        t.lineTo(a, o),
        t.closePath(),
  ...
  fillBorderBottom = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.width,
      u = e.height,
      c = r.borderBottomColor,
      h = r.borderBottomStyle,
      l = r.borderBottomWidth,
  ...
  clipBorderLeft = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.width,
      u = e.height,
    ...
    var f = a + Math.max(h, i);
    t.lineTo(f, o), t.lineTo(f, o + c);
    var p = Math.max(i - h, 0),
      g = Math.max(i - c, 0),
      m = p * (1 - KAPPA),
      y = g * (1 - KAPPA);
    t.bezierCurveTo(
      ...
      t.lineTo(a + h, o + u - Math.max(n, l));
    var v = Math.max(n - h, 0),
      b = Math.max(n - l, 0),
      T = v * (1 - KAPPA),
      _ = b * (1 - KAPPA),
      E = a + Math.max(n, h);
    t.bezierCurveTo(a + h, o + u - l - _, a + h + T, o + u - l, E, o + u - l),
      t.lineTo(E, o + u),
      t.lineTo(a + n, o + u);
    var R = n * (1 - KAPPA);
    if (
      (t.bezierCurveTo(a + R, o + u, a, o + u - R, a, o + u - n),
      t.closePath(),
      t.clip(),
      l)
    ) {
  ...
  fillBorderLeft = function(t, e, r, n, i) {
    var o = e.top,
      a = e.left,
      s = e.height,
      u = r.borderLeftColor,
  ...
  Borders = { drawBorders: drawBorders },
  KAPPA$1 = ((Math.sqrt(2) - 1) / 3) * 4,
  Clipping = {
    clip: function() {
      var t = this.getAbsoluteLayout(),
        e = t.top,
        ...
        c = void 0 === u ? 0 : u,
        h = o.borderBottomRightRadius,
        l = void 0 === h ? 0 : h,
        d = o.borderBottomLeftRadius,
        f = void 0 === d ? 0 : d,
        p = Math.min(c, 0.5 * n, 0.5 * i),
        g = p * (1 - KAPPA$1);
      ...
      this.root.instance.lineTo(r, e + T),
        this.root.instance.bezierCurveTo(r, e + _, r + _, e, r + T, e),
  ...
  applySingleTransformation = function(t, e, r) {
    if (/rotate/g.test(e))
      ...
      var n;
      (n = t.root.instance).transform.apply(n, getMatrix(e));
    }
  },
  Transformations = {
  ...
  Base = (function(t) {
    function e(r, n) {
      var i;
      return (
        ((i = t.call(this) || this).root = r),
        (i.style = {}),
        (i.props = merge({}, i.constructor.defaultProps, e.defaultProps, n)),
        warning(
          !i.props.styles,
    ...
    var r = e.prototype;
    return (
      (r.appendChild = function(e) {
        t.prototype.appendChild.call(this, e), this.root.markDirty();
      }),
      (r.appendChildBefore = function(e, r) {
        t.prototype.appendChildBefore.call(this, e, r), this.root.markDirty();
      }),
      (r.removeChild = function(e) {
        t.prototype.removeChild.call(this, e), this.root.markDirty();
      }),
      (r.update = function(t) {
        (this.props = merge(
          {},
      ...
      (r.applyProps = function() {
        var t = this;
        (this.style = this.resolveStyles()),
          toPairsIn(this.style).map(function(e) {
            var r = e[0],
              n = e[1];
            t.applyStyle(r, n);
          }),
      ...
      (r.resolveStyles = function() {
        var t = this.page,
          e = t.size,
          r = t.orientation,
          n = StyleSheet.resolve(this.props.style, {
            orientation: r,
            width: e.width,
            height: e.height,
          }),
          i = this.parent ? pick(this.parent.style, inheritedProperties) : {};
        return _extends({}, i, n);
      }),
      (r.applyStyle = function(t, e) {
        if (void 0 !== e) {
          var r = 'set' + upperFirst(t);
          switch (t) {
            case 'marginTop':
      ...
      (r.drawBackgroundColor = function() {
        var t = this.style,
          e = t.backgroundColor,
          r = t.opacity,
          n = void 0 === r ? 1 : r,
        ...
        },
        {
          ...
          get: function() {
            var t = this.style,
              ...
              u = matchPercent(e),
              c = matchPercent(r);
            return [i + (u ? a * u.percent : e), o + (c ? s * c.percent : r)];
          },
        },
      ]),
      e
...
var RULER_WIDTH = 13,
  ...
  matchPercentage = function(t) {
    var e = matchPercent(t);
  ...
  Ruler = {
    ...
    getHorizontalSteps: function() {
      var t =
        ...
        DEFAULT_RULER_STEPS;
      if ('string' == typeof t) {
        var e = matchPercentage(t);
        if (e)
          return (this.width - (this.hasVerticalRuler() ? RULER_WIDTH : 0)) / e;
    ...
    getVerticalSteps: function() {
      ...
      if ('string' == typeof t) {
        ...
        if (e)
          return (
            (this.height - (this.hasHorizontalRuler() ? RULER_WIDTH : 0)) / e
          );
        throw new Error('Page: Invalid horizontal steps value');
      }
      return t;
    ...
    drawHorizontalRuler: function() {
      var t = this,
        e = this.hasVerticalRuler() ? RULER_WIDTH : 0;
      this.root.instance
        .rect(e, 0, this.width, RULER_WIDTH)
        .fill(RULER_COLOR)
        .moveTo(this.hasVerticalRuler() ? RULER_WIDTH : 0, RULER_WIDTH)
        .lineTo(this.width, RULER_WIDTH)
        .stroke(LINE_COLOR);
      var r = range(this.width, this.getHorizontalSteps());
      r.map(function(r) {
        t.root.instance
          .moveTo(e + r, 0)
          .lineTo(e + r, RULER_WIDTH)
          .stroke(LINE_COLOR)
          .fillColor('black')
    ...
    drawVerticalRuler: function() {
      var t = this,
        e = this.hasHorizontalRuler() ? RULER_WIDTH : 0;
      this.root.instance
        .rect(0, e, RULER_WIDTH, this.height)
        .fill(RULER_COLOR)
        .moveTo(RULER_WIDTH, this.hasHorizontalRuler() ? RULER_WIDTH : 0)
        .lineTo(RULER_WIDTH, this.height)
        .stroke(LINE_COLOR);
      var r = range(this.height, this.getVerticalSteps());
      r.map(function(r) {
        t.root.instance
          .moveTo(0, e + r)
          .lineTo(RULER_WIDTH, e + r)
          .stroke(LINE_COLOR)
          .fillColor('black')
  ...
  getPageSize = function(t, e) {
    var r;
    if ((void 0 === e && (e = 'portrait'), 'string' == typeof t))
      r = PAGE_SIZES[t.toUpperCase()];
  ...
  Page = (function(t) {
    function e(e, r) {
      var n;
      return ((n = t.call(this, e, r) || this)._size = null), n;
    }
    _inheritsLoose(e, t);
    var r = e.prototype;
    return (
      ...
      (r.applyProps = function() {
        t.prototype.applyProps.call(this),
          (this.top = 0),
          (this.left = 0),
          (this.width = this.size.width),
          this.resetMargins();
        var e = this.getRulerWidth();
        this.hasHorizontalRuler() && (this.paddingTop = this.paddingTop + e),
          this.hasVerticalRuler() && (this.paddingLeft = this.paddingLeft + e);
      }),
      (r.setPadding = function(t, e) {
        var r =
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 4:
                      ...
                      (u = new TextInstance(this.root, o)),
                        e.appendChild(u),
                        (t.next = 24);
                      break;
                    case 12:
                      ...
                      return (
                        (c = createInstance(o, this.root)),
                        (t.next = 16),
                        c.onAppendDynamically()
                      );
                    case 16:
                      return (
                        e.appendChild(c),
                        c.applyProps(),
                        (t.next = 20),
                        this.addDynamicChild(c, s.children)
                      );
                    case 20:
                      t.next = 24;
                      break;
                    case 22:
                      return (t.next = 24), this.addDynamicChild(e, s.children);
                    case 24:
                      i++, (t.next = 4);
                      break;
                    case 27:
      ...
      (r.clone = function() {
        ...
        return (e._size = this.size), e;
      }),
      (r.update = function(e) {
        t.prototype.update.call(this, e), (this._size = null);
      }),
      (r.render = (function() {
        var t = _asyncToGenerator(
          _regeneratorRuntime.mark(function t() {
...
var emojiSource,
  ...
  FontSource = (function() {
    function t(t, e, r, n, i, o) {
      (this.src = t),
        ...
        (this.fontWeight = processFontWeight(n) || 400),
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      ...
                      return (
                        ...
                        (o = void 0 === i ? 'GET' : i),
                        (t.next = 5),
                        fetchFont(this.src, { method: o, body: n, headers: r })
                      );
                    case 5:
                      (a = t.sent),
                        (this.data = fontkit.create(a)),
                        (t.next = 13);
                      break;
                    case 9:
                      return (
                        throwInvalidUrl(this.src),
                        (t.next = 12),
                        new Promise(function(t, e) {
                          return fontkit.open(s.src, function(r, n) {
                            return r ? e(r) : t(n);
                          });
                        })
                      );
    ...
    return (
      (e.register = function(t) {
        var e = t.src,
          ...
          n = t.fontStyle,
          i = t.unicodeRange,
          o = _objectWithoutPropertiesLoose(t, [
            'src',
            'fontWeight',
            'fontStyle',
            'unicodeRange',
          ]);
        this.sources.push(new FontSource(e, this.fontFamily, n, r, i, o));
      }),
      (e.resolve = function(t) {
        ...
        if (
          (n < 400 && (e = h[h.length - 1] || l[0]),
          n > 500 && (e = l[0] || h[h.length - 1]),
          !e)
        )
          throw new Error(
  ...
  registerEmojiSource = function(t) {
    var e = t.url,
      r = t.format;
    emojiSource = { url: e, format: void 0 === r ? 'png' : r };
  },
...
var fonts = {},
  register = function(t, e) {
    ...
    if ((fonts[r] || (fonts[r] = Font.create(r)), e.fonts))
      for (var n = 0; n < e.fonts.length; n++)
        fonts[r].register(_extends({ family: r }, e.fonts[n]));
  ...
  load = function(t, e, r) {
    for (
      var n,
        i = t.fontFamily,
        o = _objectWithoutPropertiesLoose(t, ['fontFamily']),
        a = [],
        s = _createForOfIteratorHelperLoose(
          'string' == typeof i
      ...
      var u = n.value;
      if (standardFonts.includes(u)) break;
      var c = getFont(_extends({}, o, { fontFamily: u }));
      if (
        ('string' != typeof r || r.search(c.unicodeRange) >= 0) &&
        !c.data &&
        !c.loading &&
        (a.push(c.load()), '.' === c.unicodeRange.source)
      )
        break;
    }
  ...
  reset = function() {
    for (var t in fonts) fonts.hasOwnProperty(t) && (fonts[t].data = null);
  },
  clear = function() {
    fonts = {};
  },
...
function _createForOfIteratorHelperLoose$1(t, e) {
  var r;
  if ('undefined' == typeof Symbol || null == t[Symbol.iterator]) {
    if (
      Array.isArray(t) ||
      (r = _unsupportedIterableToArray$1(t)) ||
      (e && t && 'number' == typeof t.length)
    ) {
      r && (t = r);
      var n = 0;
          ...
          (r.getRuns = function(t, r) {
            for (
              var n,
                ...
                a = 0,
                s = 0,
                u = _createForOfIteratorHelperLoose$1(r);
              !(n = u()).done;

            ) {
              var c = n.value,
                h =
                  'string' == typeof c.attributes.font
                    ? this.getOrCreateFont(c.attributes.font)
                    : c.attributes.font;
              if (0 === t.length) {
                i.push(new e(0, 0, { font: h }));
                break;
              }
              for (
                var l,
                  d = _createForOfIteratorHelperLoose$1(
                ...
                var f = l.value,
                  p = f.codePointAt(),
                  g = this.shouldFallbackToFont(p, h) ? this.fallbackFont : h;
                g !== o &&
      ...
      return (function() {
        ...
        return (
          (r.calculateParts = function(t) {
            return t.includes(SOFT_HYPHEN_HEX)
              ? t.split(SOFT_HYPHEN_HEX)
              : hyphen(t).split(SOFT_HYPHEN_HEX);
          }),
...
var linebreak = function t(e, r, n) {
  var i = {
      demerits: {
  ...
  function l(r, n, i, o) {
    ...
    return (
      ...
      u < l
        ? (c = a.stretch - i.totals.stretch) > 0
          ? (l - u) / c
          : t.infinity
        : u > l
        ? (h = a.shrink - i.totals.shrink) > 0
          ? (l - u) / h
          : t.infinity
        : 0
    );
      ...
      for (s = d(r), u = 0; u < v.length; u += 1)
        (c = v[u]).demerits < 1 / 0 &&
          ((f = new LinkedList.Node(
            h(r, c.demerits, c.ratio, c.active.data.line + 1, u, s, c.active),
          )),
          null !== p ? o.insertBefore(p, f) : o.push(f));
    }
  }
  if (
    (o.push(new LinkedList.Node(h(0, 0, 0, 0, 0, void 0, null))),
    ...
    for (
      o.forEach(function(t) {
        t.data.demerits < c.data.demerits && (c = t);
      });
      null !== c;

    )
      u.push({ position: c.data.position, ratio: c.data.ratio }),
        (c = c.data.previous);
    return u.reverse();
  }
  return [];
...
var INFINITY = 1e4,
  getNextBreakpoint = function(t, e, r) {
    for (
      ...
      if (
        ...
        break;
      if ('penalty' === c.type || 'glue' === c.type) {
        var h = s(c),
          l = 'penalty' === c.type ? c.penalty : 0,
          d = 100 * Math.pow(Math.abs(h), 3) + l;
        i >= d && ((n = u), (i = d));
      }
    }
    return o.width - o.shrink > a ? n : null;
  },
  applyBestFit = function(t, e) {
    for (var r = 0, n = 0, i = t, o = [{ position: 0 }]; i.length > 0; ) {
      var a = getNextBreakpoint(i, e, n);
      a
        ? ((r += a),
          o.push({ position: r }),
            ...
            var i = n.align,
              ...
              s = r.reduce(function(e, n, i) {
                var s = t.glyphIndexForStringIndex(o),
                  ...
                  c = t.slice(s, u);
                if ('' === c.string.trim()) {
                  var h = c.advanceWidth,
                    l = (h * opts.width) / opts.stretch,
                    d = (h * opts.width) / opts.shrink,
                    f = { value: c, start: o, end: o + c.end };
                  e.push(linebreak.glue(h, f, l, d));
                } else {
                  var p = ' ' !== r[i + 1],
                    g = { value: c, start: o, end: o + c.end };
                  e.push(linebreak.box(c.advanceWidth, g, p)),
                    r[i + 1] && p && e.push(linebreak.penalty(5, a, 1));
                }
                return (o += n.length), e;
              }, []);
            return (
                ...
                return o.position === e.length - 1
                  ...
                  : ('penalty' === s.type
                      ? ((i = t.glyphIndexForStringIndex(u.value.end)),
                        (a = t.copy().slice(n, i)).insertGlyph(
                          a.length,
                          HYPHEN,
                        ))
          ...
          (r.suggestLineBreak = function(t, e, r, n) {
            for (
              var i = this.getNodes(t, e, n),
                o = this.tolerance,
                a = linebreak(i, r, { tolerance: o });
              0 === a.length && o < TOLERANCE_LIMIT;

            )
              a = linebreak(i, r, { tolerance: (o += TOLERANCE_STEPS) });
            return (
  ...
  LayoutEngine = (function(t) {
    function e(e) {
      var r = e.hyphenationCallback,
        n = e.hyphenationPenalty,
        i = {
          scriptItemizer: scriptItemizer(),
          decorationEngine: textDecorationEngine(),
          fontSubstitutionEngine: fontSubstitutionEngine(),
          wordHyphenation: wordHyphenation({ hyphenationCallback: r }),
          lineBreaker: lineBreaker({ penalty: n }),
...
var createCache = function(t) {
    var e = (void 0 === t ? {} : t).limit,
      r = void 0 === e ? 100 : e,
      n = {},
      i = [];
    return {
      ...
      set: function(t, e) {
        i.push(t), i.length > r && delete n[i.shift()], (n[t] = e);
      },
      reset: function() {
        (n = {}), (i = []);
      },
  ...
  toBuffer = function(t) {
    return new Promise(function(e, r) {
      return toBufferCb(t, function(t, n) {
        return t ? r(t) : e(n);
      });
    });
  },
          ...
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                ...
                break;
              case 3:
                return t.abrupt('return', new JPEG(e));
              case 4:
                return t.abrupt('return', new PNG(e));
              case 5:
                t.next = 7;
                break;
              case 7:
                return (
                  ...
                  jpegasus
                    .compress(
                      new File([toArrayBuffer(e)], 'image.gif', {
                        type: 'image/gif',
                      }),
                      { quality: 0.8 },
                    )
              ...
              case 9:
                return (n = t.sent), t.abrupt('return', new JPEG(n));
              case 11:
  ...
  resolveBase64Image = function(t) {
    var e = t.uri,
      r = /^data:image\/([a-zA-Z]*);base64,([^"]*)/.exec(e),
      n = r[1],
      i = r[2];
    if (!isValidFormat(n)) throw new Error('Base64 image invalid format: ' + n);
    return getImage(Buffer.from(i, 'base64'), n);
  },
  resolveImageFromData = function(t) {
    if (t.data && t.format) return getImage(t.data, t.format);
    throw new Error('Invalid data given for local file: ' + JSON.stringify(t));
  },
  resolveBufferImage = function(t) {
    var e = guessFormat(t);
          ...
          for (;;)
            switch ((t.prev = t.next)) {
              ...
              case 7:
                return (
                  (t.next = 9),
                  fetchRemoteFile(n, { body: i, headers: o, method: s })
                );
              case 9:
                t.t0 = t.sent;
              case 10:
  ...
  resolveImage = function(t, e) {
    var r,
      n = void 0 === e ? {} : e,
      i = n.cache,
      o = void 0 === i || i,
      a = _objectWithoutPropertiesLoose(n, ['cache']),
      s = t.data ? t.data.toString() : t.uri;
    if (o && IMAGE_CACHE.get(s)) return IMAGE_CACHE.get(s);
    if (
      !(r = isCompatibleBase64(t)
        ? resolveBase64Image(t)
        : Buffer.isBuffer(t)
        ? resolveBufferImage(t)
        : 'object' == typeof t && t.data
        ? resolveImageFromData(t)
        : resolveImageFromUrl(t, a))
    )
      throw new Error('Cannot resolve image');
    return o && IMAGE_CACHE.set(s, r), r;
  },
  emojis = {},
  regex = emojiRegex(),
  reflect = function(t) {
  ...
  makeFetchEmojiImage = function() {
    return reflect(resolveImage);
  },
  _removeNoColor = function(t) {
    return '️' !== t;
  },
  ...
  buildEmojiUrl = function(t) {
    var e = Font$1.getEmojiSource(),
      r = e.url,
      n = e.format;
    return '' + r + getCodePoints(t) + '.' + n;
  },
  fetchEmojis = function(t) {
    var e = Font$1.getEmojiSource();
    if (!e || !e.url) return [];
    for (
      var r,
        ...
        i = function() {
          ...
          if (!emojis[t] || emojis[t].loading) {
            var e = buildEmojiUrl(t);
            emojis[t] = { loading: !0 };
            var i = makeFetchEmojiImage();
            n.push(
              i({ uri: e }).then(function(e) {
  ...
  embedEmojis = function(t) {
    for (var e = [], r = 0; r < t.length; r++) {
      for (var n = t[r], i = void 0, o = 0; (i = regex.exec(n.string)); ) {
        var a = i.index,
          s = i[0],
          u = n.attributes.fontSize,
          c = n.string.slice(o, a + i[0].length);
        emojis[s] && emojis[s].data
          ? e.push({
              string: c.replace(i, textkitCore.Attachment.CHARACTER),
              attributes: _extends({}, n.attributes, {
                attachment: new textkitCore.Attachment(u, u, {
                  yOffset: Math.floor(0.1 * u),
                  image: emojis[s].data,
                }),
              }),
            })
          : e.push({
              string: c.replace(i, String.fromCharCode(0)),
              attributes: n.attributes,
            }),
          (o = a + s.length);
      }
      o < n.string.length &&
        e.push({ string: n.string.slice(o), attributes: n.attributes });
    }
    return e;
  },
  IGNORABLE_CODEPOINTS = [8232, 8233],
  buildSubsetForFont = function(t) {
    return IGNORABLE_CODEPOINTS.reduce(function(e, r) {
      return t.hasGlyphForCodePoint && t.hasGlyphForCodePoint(r)
        ? e
        : [].concat(e, [String.fromCharCode(r)]);
    }, []);
  },
  ignoreChars = function(t) {
    return t.map(function(t) {
      var e = buildSubsetForFont(t.attributes.font),
        r = new RegExp(e.join('|'));
      return { string: t.string.replace(r, ''), attributes: t.attributes };
    });
  };
function _createForOfIteratorHelperLoose$2(t, e) {
  var r;
  if ('undefined' == typeof Symbol || null == t[Symbol.iterator]) {
    if (
      Array.isArray(t) ||
      (r = _unsupportedIterableToArray$2(t)) ||
      (e && t && 'number' == typeof t.length)
    ) {
      r && (t = r);
      var n = 0;
...
var PREPROCESSORS = [ignoreChars, embedEmojis],
  ...
  getFragments = function t(e) {
    ...
    var r = [],
      ...
      _ = n.textDecorationStyle,
      E = n.textTransform,
      R = n.letterSpacing,
      w = n.opacity;
    e.children.forEach(function(n) {
      if (null !== n.value && void 0 !== n.value) {
        var i = Font$1.getFont({ fontFamily: u, fontWeight: c, fontStyle: h }),
          s = i ? i.data : u,
          l = transformText(n.value, E);
        r.push({
          string: l,
          attributes: {
            font: s,
        ...
        var f;
        if (n) (f = r).push.apply(f, t(n));
      }
    });
    for (
      var P, x = _createForOfIteratorHelperLoose$2(PREPROCESSORS);
      !(P = x()).done;
  ...
  getAttributedString = function(t) {
    return textkitCore.AttributedString.fromFragments(getFragments(t)).trim();
  },
  ...
  Text = (function(t) {
    function e(e, r) {
      var n;
      return (
        ((n = t.call(this, e, r) || this).start = 0),
        (n.end = 0),
        (n.computed = !1),
        (n.container = null),
        (n.attributedString = null),
        (n.layoutEngine = new LayoutEngine({
          hyphenationPenalty: r.hyphenationPenalty,
          hyphenationCallback: Font$1.getHyphenationCallback(),
        })),
        n.layout.setMeasureFunc(n.measureText.bind(_assertThisInitialized(n))),
        n
      );
    }
    _inheritsLoose(e, t);
    ...
    return (
      ...
      (r.lineIndexAtHeight = function(t) {
      ...
      (r.measureText = function(t, e, r, n) {
        return e === Yoga.MEASURE_MODE_EXACTLY
          ? (this.layoutText(t),
            { height: this.style.flexGrow ? NaN : this.linesHeight })
          : e === Yoga.MEASURE_MODE_AT_MOST || n === Yoga.MEASURE_MODE_AT_MOST
          ? (this.layoutText(t, r),
            { height: this.linesHeight, width: Math.min(t, this.linesWidth) })
          : {};
      }),
      (r.resolveStyles = function() {
        var e = t.prototype.resolveStyles.call(this);
        return (
          this.parent &&
            'Text' === this.parent.name &&
            'relative' === this.parent.style.position &&
            ((e.top = e.top || this.parent.style.top),
            (e.bottom = e.bottom || this.parent.style.bottom),
            (e.position = e.position || 'relative')),
          this.src &&
            ((e.color = e.color || 'blue'),
            (e.textDecoration = e.textDecoration || 'underline')),
          e
        );
      }),
      (r.wrapHeight = function(t) {
        var e = this.props,
          r = e.orphans,
          n = e.widows,
          i = this.lines.length,
      ...
      (r.clone = function() {
        var e = t.prototype.clone.call(this);
        return (
          (e.layoutEngine = this.layoutEngine),
          this.container &&
            !this.props.render &&
            (e.container = this.container.copy()),
          e
        );
      }),
      (r.render = (function() {
                    ...
                    case 0:
                      this.root.instance.save(),
                        ...
                        this.lines.forEach(function(t) {
                          (t.rect.x += n + a.padding.left),
                            (t.rect.y += r + a.padding.top - i);
                        }),
                        (o = _extends({}, this.container, {
...
var Link = (function(t) {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        (i = e.width),
                        (o = e.height),
                        this.root.instance.link(n, r, i, o, this.src),
                        (t.next = 4),
                        this.renderChildren()
                      );
                    case 4:
  ...
  Note = (function(t) {
    ...
    return (
      ...
      (r.applyProps = function() {
        t.prototype.applyProps.call(this), (this.height = 0), (this.width = 0);
      }),
      (r.render = (function() {
        var t = _asyncToGenerator(
          _regeneratorRuntime.mark(function t() {
...
var isNumeric = function(t) {
  ...
  applyContainObjectFit = function(t, e, r, n, i, o) {
    var a = t / e,
      s = r / n,
      u = matchPercent(i),
      c = matchPercent(o),
    ...
    return {
      width: g,
      height: m,
      yOffset: isNumeric(o) ? o : (e - m) * l,
      xOffset: y,
    };
  },
  applyNoneObjectFit = function(t, e, r, n, i, o) {
    var a = r,
      s = n,
      u = matchPercent(i),
      c = matchPercent(o),
    ...
    return {
      width: a,
      height: s,
      xOffset: isNumeric(i) ? i : (t - a) * h,
      yOffset: isNumeric(o) ? o : (e - s) * l,
    };
  },
  applyCoverObjectFit = function(t, e, r, n, i, o) {
    var a = r / n,
      s = t / e,
      u = matchPercent(i),
      c = matchPercent(o),
    ...
    return {
      width: g,
      height: e,
      xOffset: isNumeric(i) ? i : (t - g) * h,
      yOffset: isNumeric(o) ? o : 0,
    };
  },
  applyScaleDownObjectFit = function(t, e, r, n, i, o) {
    var a = applyContainObjectFit(t, e, r, n, i, o),
      s = applyNoneObjectFit(t, e, r, n, i, o);
    return a.width < s.width ? a : s;
  },
  applyFillObjectFit = function(t, e, r, n) {
    return {
      width: t,
      height: e,
      xOffset: matchPercent(r) ? 0 : r || 0,
      yOffset: matchPercent(n) ? 0 : n || 0,
    };
  },
  resolveObjectFit = function(t, e, r, n, i, o, a) {
    switch ((void 0 === t && (t = 'fill'), t)) {
      case 'contain':
        return applyContainObjectFit(e, r, n, i, o, a);
      case 'cover':
        return applyCoverObjectFit(e, r, n, i, o, a);
      case 'none':
        return applyNoneObjectFit(e, r, n, i, o, a);
      case 'scale-down':
        return applyScaleDownObjectFit(e, r, n, i, o, a);
      default:
        return applyFillObjectFit(e, r, o, a);
    }
  },
  SAFETY_HEIGHT = 10,
  Image = (function(t) {
    function e(e, r) {
      var n;
      return (
        ((n = t.call(this, e, r) || this).image = null),
        n.layout.setMeasureFunc(n.measureImage.bind(_assertThisInitialized(n))),
        n
      );
    }
    _inheritsLoose(e, t);
    var r = e.prototype;
    return (
      (r.shouldGrow = function() {
        return !!this.style.flexGrow;
      }),
      (r.measureImage = function(t, e, r, n) {
        var i = this.margin,
          o = this.page.padding,
          a =
      ...
      (r.clone = function() {
        var e = t.prototype.clone.call(this);
        return (e.image = this.image), e;
      }),
      (r.onAppendDynamically = (function() {
        var t = _asyncToGenerator(
          _regeneratorRuntime.mark(function t() {
            return _regeneratorRuntime.wrap(
              function(t) {
...
function _createForOfIteratorHelperLoose$3(t, e) {
  var r;
  if ('undefined' == typeof Symbol || null == t[Symbol.iterator]) {
    if (
      Array.isArray(t) ||
      (r = _unsupportedIterableToArray$3(t)) ||
      (e && t && 'number' == typeof t.length)
    ) {
      r && (t = r);
      var n = 0;
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    for (
                      e = [],
                        r = this.children.map(function(t) {
                          return [t, {}];
                        }),
                        n = function() {
                          var t = r.shift(),
                          ...
                          'string' == typeof n
                            ? e.push.apply(
                                e,
                                fetchEmojis(n).concat([
                                  Font$1.load(a, i.root.instance, n),
                                ]),
                              )
                            : 'string' == typeof n.value
                            ? e.push.apply(
                                e,
                                fetchEmojis(n.value).concat([
                                  Font$1.load(
                                    n.style || a,
                                    i.root.instance,
                                    n.value,
                            ...
                            : n.children &&
                              n.children.forEach(function(t) {
                                r.push([
                                  t,
                                  { parentStyle: _extends({}, a, n.style) },
                                ]);
                              });
                        };
                      r.length > 0;
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    (e = 1),
                      (r = []),
                      (n = _createForOfIteratorHelperLoose$3(this.children));
                  case 3:
                    if ((i = n()).done) {
                      t.next = 18;
                      break;
                    ...
                    if (
                      ((o = i.value),
                      (a = o.size.height - (o.style.paddingBottom || 0)),
                      !o.wrap)
                    ) {
                      t.next = 14;
                      break;
                    }
                    return (t.next = 9), _wrapPages(o, a, e);
                  case 9:
                    (s = t.sent),
                      (e += s.length),
                      r.push.apply(r, s),
                    ...
                    break;
                  case 14:
                    (o.height = o.size.height), r.push(o);
                  case 16:
                    t.next = 3;
                    break;
                  case 18:
            ...
            function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 7:
                    this.root.instance.end(), Font$1.reset(), (t.next = 14);
                    break;
                  case 11:
...
var availableMethods = [
  ...
  painter = function(t) {
    var e = availableMethods.reduce(function(r, n) {
      var i;
      return _extends(
        {},
        r,
        (((i = {})[n] = function() {
          return t[n].apply(t, arguments), e;
        }),
        i),
      );
    }, {});
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      (e = this.getAbsoluteLayout()),
                        ...
                        (i = e.width),
                        (o = e.height),
                        (a = i - this.paddingLeft - this.paddingRight),
                        (s = o - this.paddingTop - this.paddingBottom),
                        warning(
                          a && s,
                        ...
                        this.props.paint &&
                          this.props.paint(painter(this.root.instance), a, s),
                        this.root.instance.restore(),
                        this.props.debug && this.debug();
                    case 13:
                    case 'end':
...
var propsEqual = function t(e, r) {
  ...
  emptyObject = {},
  shouldReplaceLink = function(t, e) {
    return (
      'LINK' === t &&
  ...
  PDFRenderer$1 = ReactFiberReconciler({
    ...
    createTextInstance: function(t, e) {
      return createInstance({ type: 'TEXT_INSTANCE', props: t }, e);
    },
  ...
  Canvas$1 = 'CANVAS',
  pdf = function(t) {
    var e = createInstance({ type: 'ROOT' }),
      r = PDFRenderer$1.createContainer(e);
    function n(t) {
      if ((void 0 === t && (t = {}), e.document.props.onRender)) {
        var r = e.document.getLayoutData();
        e.document.props.onRender(_extends({}, t, { layoutData: r }));
      }
    }
    function i(t) {
          ...
          return _regeneratorRuntime.wrap(function(t) {
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 2:
                  return (
                    (r = e.instance.pipe(BlobStream())),
                    t.abrupt(
                      'return',
                      new Promise(function(t, e) {
                        r.on('finish', function() {
                          try {
                            var i = r.toBlob('application/pdf');
                            n({ blob: i }), t(i);
                          } catch (t) {
                            e(t);
                          }
  ...
  flatStyles = function(t) {
    return t.reduce(function(t, e) {
      return _extends({}, t, e);
    }, {});
  },
  Document$2 = function(t) {
    var e = t.children,
      r = _objectWithoutPropertiesLoose(t, ['children']);
    return React__default.createElement(Document$1, r, e);
  },
  InternalBlobProvider = (function(t) {
    function e(e) {
      var r;
      return (
    ...
    return (
      ...
      (r.renderDocument = function() {
        this.instance.updateContainer(this.props.document);
      }),
      (r.onDocumentUpdate = function() {
        var t = this,
          e = this.state.url;
        this.instance
          .toBlob()
  ...
  BlobProvider = function(t) {
    var e = t.document,
      r = t.children;
    return e
      ? React__default.createElement(InternalBlobProvider, { document: e }, r)
      : (warning(!1, 'You should pass a valid document to BlobProvider'), null);
  },
  PDFViewer = function(t) {
    var e = t.className,
      r = t.style,
      n = t.children,
      i = t.innerRef,
          ...
          _extends(
            {
              ...
              ref: i,
              src: n,
              style: Array.isArray(r) ? flatStyles(r) : r,
            },
            o,
          ),
        );
  ...
  PDFDownloadLink = function(t) {
    var e = t.document,
      r = t.className,
      n = t.style,
      i = t.children,
      o = t.fileName,
      a = void 0 === o ? 'document.pdf' : o;
    if (!e)
      return (
        warning(!1, 'You should pass a valid document to PDFDownloadLink'), null
      );
    return React__default.createElement(
      InternalBlobProvider,
      { document: e },
      function(t) {
        return React__default.createElement(
          'a',
          {
            ...
            style: Array.isArray(n) ? flatStyles(n) : n,
          },
