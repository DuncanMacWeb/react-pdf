...
var justificationEngine = _interopDefault(
  require('@textkit/justification-engine'),
);
var textDecorationEngine = _interopDefault(
  require('@textkit/text-decoration-engine'),
);
  ...
  var result = Object.keys(input).reduce(function(acc, key) {
    ...
    if (/@media/.test(key)) {
      ...
      return _extends(
        ...
        acc,
        matchMedia(
          ((_matchMedia = {}), (_matchMedia[key] = input[key]), _matchMedia),
          container,
        ),
      );
    }
    ...
    return _extends(
      {},
      acc,
      ((_extends2 = {}), (_extends2[key] = input[key]), _extends2),
    );
  }, {});
  return result;
};
...
function drawBorders() {
  ...
  var _this$style = this.style,
    ...
    borderTopLeftRadius =
      _this$style$borderTop === void 0 ? 0 : _this$style$borderTop,
    _this$style$borderTop2 = _this$style.borderTopRightRadius,
    borderTopRightRadius =
      _this$style$borderTop2 === void 0 ? 0 : _this$style$borderTop2,
    _this$style$borderBot = _this$style.borderBottomLeftRadius,
    borderBottomLeftRadius =
      _this$style$borderBot === void 0 ? 0 : _this$style$borderBot,
    _this$style$borderBot2 = _this$style.borderBottomRightRadius,
    borderBottomRightRadius =
      _this$style$borderBot2 === void 0 ? 0 : _this$style$borderBot2,
    _this$style$borderTop3 = _this$style.borderTopColor,
    borderTopColor =
      _this$style$borderTop3 === void 0 ? 'black' : _this$style$borderTop3,
    _this$style$borderTop4 = _this$style.borderTopStyle,
    borderTopStyle =
      _this$style$borderTop4 === void 0 ? 'solid' : _this$style$borderTop4,
    _this$style$borderLef = _this$style.borderLeftColor,
    borderLeftColor =
      _this$style$borderLef === void 0 ? 'black' : _this$style$borderLef,
    _this$style$borderLef2 = _this$style.borderLeftStyle,
    borderLeftStyle =
      _this$style$borderLef2 === void 0 ? 'solid' : _this$style$borderLef2,
    _this$style$borderRig = _this$style.borderRightColor,
    borderRightColor =
      _this$style$borderRig === void 0 ? 'black' : _this$style$borderRig,
    _this$style$borderRig2 = _this$style.borderRightStyle,
    borderRightStyle =
      _this$style$borderRig2 === void 0 ? 'solid' : _this$style$borderRig2,
    _this$style$borderBot3 = _this$style.borderBottomColor,
    borderBottomColor =
      _this$style$borderBot3 === void 0 ? 'black' : _this$style$borderBot3,
    _this$style$borderBot4 = _this$style.borderBottomStyle,
    borderBottomStyle =
      _this$style$borderBot4 === void 0 ? 'solid' : _this$style$borderBot4;
  var style = {
...
var Clipping = {
  clip: function clip() {
    ...
    var _this$style = this.style,
      ...
      borderBottomLeftRadius =
        _this$style$borderBot2 === void 0 ? 0 : _this$style$borderBot2; // Border top
...
var getTranslateX = function getTranslateX(transform) {
  ...
  var matchGeneric = /translate\((-?\d+\.?d*).*,\s*(-?\d+\.?d*).*\)/g.exec(
    transform,
  );
...
var getScaleX = function getScaleX(transform) {
  ...
  var matchGeneric = /scale\((-?\d+\.?\d*).*,\s*(-?\d+\.?\d*).*\)/g.exec(
    transform,
  );
  if (matchX && matchX[1]) return matchX[1];
  if (matchGeneric && matchGeneric[1]) return matchGeneric[1];
...
var applySingleTransformation = function applySingleTransformation(
  ...
  if (/rotate/g.test(transform)) {
    ...
    (_element$root$instanc = element.root.instance).transform.apply(
      _element$root$instanc,
      getMatrix(transform),
    );
  }
};
...
var Base = /*#__PURE__*/ (function(_Node) {
  ...
  function Base(root, props) {
    ...
    warning(
      !_this.props.styles,
      '"styles" prop passed instead of "style" prop',
    );
    return _this;
  }
  ...
  _proto.resolveStyles = function resolveStyles() {
    ...
    var inheritedStyles = this.parent
    ...
    hRange.map(function(step) {
      if (step !== 0) {
        _this.root.instance
          ...
          .lineTo(offset + step, _this.height)
          .stroke(GRID_COLOR);
      }
    });
  },
    ...
    vRange.map(function(step) {
      if (step !== 0) {
        _this2.root.instance
          ...
          .lineTo(_this2.width, offset + step)
          .stroke(GRID_COLOR);
      }
    });
  },
...
var Page = /*#__PURE__*/ (function(_Base) {
  ...
  _proto.renderDynamicNodes = /*#__PURE__*/ (function() {
    var _renderDynamicNodes = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime.mark(function _callee2(props, cb) {
  ...
  _proto.nodeWillWrap = /*#__PURE__*/ (function() {
    var _nodeWillWrap = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime.mark(function _callee3(props) {
        return _regeneratorRuntime.wrap(
...
var registerHyphenationCallback = function registerHyphenationCallback(
  callback,
) {
...
var load = function load(_ref, doc, text) {
  ...
  var fontFamilies =
    typeof fontFamily === 'string'
      ? fontFamily.split(',').map(function(family) {
          return family.trim();
        })
      : [].concat(fontFamily || []);
  var promises = [];
  ...
  for (
    var _iterator = _createForOfIteratorHelperLoose(fontFamilies), _step;
    ...
    var textRequiresFont =
      typeof text === 'string' ? text.search(_font.unicodeRange) >= 0 : true; // We cache the font to avoid fetching it many times
...
var fontSubstitutionEngine = function() {
  return function(_ref) {
    ...
    return /*#__PURE__*/ (function() {
      ...
      _proto.shouldFallbackToFont = function shouldFallbackToFont(
        codePoint,
        font,
      ) {
        return (
      ...
      _proto.getRuns = function getRuns(string, runs) {
        ...
        for (
          var _iterator = _createForOfIteratorHelperLoose$1(runs), _step;
          !(_step = _iterator()).done;
          ...
          for (
            var _iterator2 = _createForOfIteratorHelperLoose$1(
            ...
            var font = this.shouldFallbackToFont(codePoint, defaultFont)
              ? this.fallbackFont
  ...
  return function() {
    return /*#__PURE__*/ (function() {
      ...
      _proto.breakLines = function breakLines(glyphString, nodes, breaks) {
        ...
        var lastLine = glyphString.slice(
          start,
      ...
      _proto.suggestLineBreak = function suggestLineBreak(
        glyphString,
        syllables,
        availableWidths,
        paragraphStyle,
...
var LayoutEngine = /*#__PURE__*/ (function(_BaseLayoutEngine) {
...
var getImage = /*#__PURE__*/ (function() {
  var _ref5 = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime.mark(function _callee2(body, extension) {
      var jpeg;
...
var resolveImageFromUrl = /*#__PURE__*/ (function() {
  var _ref7 = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime.mark(function _callee3(src, options) {
...
var getFragments = function getFragments(instance) {
  ...
  for (
    var _iterator = _createForOfIteratorHelperLoose$2(PREPROCESSORS), _step;
    !(_step = _iterator()).done;
...
var getAttributedString = function getAttributedString(instance) {
  return textkitCore.AttributedString.fromFragments(
    getFragments(instance),
  ).trim();
};
...
var Text = /*#__PURE__*/ (function(_Base) {
  ...
  function Text(root, props) {
    ...
    _this.layout.setMeasureFunc(
      _this.measureText.bind(_assertThisInitialized(_this)),
    );
  ...
  _proto.measureText = function measureText(
    width,
    widthMode,
    height,
    heightMode,
            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  (_this$getAbsoluteLayo = this.getAbsoluteLayout()),
                    (top = _this$getAbsoluteLayo.top),
                    (left = _this$getAbsoluteLayo.left);
                  ...
                  new PDFRenderer(this.root.instance, renderOpts).render(
                    container,
                  );
...
var Image = /*#__PURE__*/ (function(_Base) {
  ...
  function Image(root, props) {
    ...
    _this.layout.setMeasureFunc(
      _this.measureImage.bind(_assertThisInitialized(_this)),
    );
  ...
  _proto.measureImage = function measureImage(
    width,
    widthMode,
    height,
    heightMode,
              ...
              switch ((_context.prev = _context.next)) {
                case 0:
                  (_this$props = this.props),
                    ...
                    (safePath = _this$props.safePath),
                    (allowDangerousPaths = _this$props.allowDangerousPaths);
...
var Document = /*#__PURE__*/ (function() {
  ...
  _proto.loadFontsAndEmojis = /*#__PURE__*/ (function() {
                ...
                case 0:
                  ...
                  _loop = function _loop() {
                    var _listToExplore$shift = listToExplore.shift(),
                      ...
                      _listToExplore$shift$ =
                        _listToExplore$shift[1].parentStyle,
                      parentStyle =
                        _listToExplore$shift$ === void 0
                          ? {}
                          : _listToExplore$shift$;
                    ...
                    if (typeof node === 'string') {
                      promises.push.apply(
                        promises,
                        fetchEmojis(node).concat([
                          Font$1.load(parentStyle, _this.root.instance, node),
                        ]),
                      );
                    } else if (typeof node.value === 'string') {
                      promises.push.apply(
                        promises,
                        fetchEmojis(node.value).concat([
                          Font$1.load(
            ...
            while (1) {
              switch ((_context4.prev = _context4.next)) {
                case 0:
                  pageCount = 1;
                  pages = [];
                  _iterator = _createForOfIteratorHelperLoose$3(this.children);
...
function createInstance(element, root) {
  ...
  throw new Error(
    'Invalid element of type ' + type + ' passed to PDF renderer',
  );
}
...
var PDFRenderer$1 = ReactFiberReconciler({
  ...
  createInstance: function createInstance$1(
    type,
    props,
